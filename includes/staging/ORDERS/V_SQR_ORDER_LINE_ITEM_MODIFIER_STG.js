...
(
 SELECT
      --MD5 KEYS
        TO_HEX(SHA256( UID )) AS K_POS_ORDER_ITEM_MODIFIER_DLHK 
        ,TO_HEX(SHA256( TRIM(COALESCE(ORDER_ID, '00000000000000000000000000000000'))  )) AS K_POS_ORDER_DLHK
        ,TO_HEX(SHA256( TRIM(COALESCE(ORDER_LINE_ITEM_ID, '00000000000000000000000000000000'))  )) AS K_POS_ORDER_LINE_ITEM_DLHK
        ,TO_HEX(SHA256( TRIM(COALESCE(CATALOG_OBJECT_ID, '00000000000000000000000000000000')) )) AS K_POS_CATALOG_OBJECT_DLHK
        ,OLI.K_POS_CATALOG_OBJECT_DLHK AS K_POS_CATALOG_OBJECT_ITEM_DLHK
        ,TO_HEX(SHA256(CONCAT(cast(TO_HEX(SHA256(TRIM(COALESCE(CATALOG_OBJECT_ID, '00000000000000000000000000000000')))) as string) ,'-',CAST(COALESCE(O.K_POS_LOCATION_BK,'00000000000000000000000000000000') AS STRING),'-',CAST(COALESCE(CM.NAME, S.NAME,'None') AS STRING),'-',cast(OLI.K_POS_CATALOG_OBJECT_DLHK as string)))) AS K_POS_CATALOG_OBJECT_DLHK_2 
        ,CONCAT(CAST(TO_HEX(SHA256(TRIM(COALESCE(CATALOG_OBJECT_ID, '00000000000000000000000000000000')))) AS STRING) ,'-',CAST(COALESCE(O.K_POS_LOCATION_BK,'00000000000000000000000000000000') AS STRING),'-',CAST(COALESCE(CM.NAME, S.NAME,'None') AS STRING),'-',cast(OLI.K_POS_CATALOG_OBJECT_DLHK as string)) AS K_POS_CATALOG_OBJECT_DLHK_3
     
        ,TO_HEX(SHA256( TRIM(COALESCE(TOTAL_PRICE_CURRENCY, '00000000000000000000000000000000')) )) AS K_CURRENCY_DLHK 
        --BUSINESS KEYS
...
LEFT JOIN source_order O ON O.K_POS_ORDER_DLHK =TO_HEX(SHA256( TRIM(COALESCE( S.ORDER_ID, '00000000000000000000000000000000'))  ))
...
SELECT 
 TO_HEX(SHA256(CONCAT(CAST(K_POS_CATALOG_OBJECT_DLHK AS STRING),CAST(K_POS_LOCATION_BK AS STRING),CAST(A_POS_PRODUCT_NAME AS STRING),CAST(COALESCE(A_POS_MODIFIER_NAME,'NA') AS STRING),CAST(K_POS_CATALOG_OBJECT_ITEM_DLHK AS STRING)))) AS K_POS_CATALOG_OBJECT_HASH_DLHK,
*
 FROM rename
